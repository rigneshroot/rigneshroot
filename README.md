...
```mermaid
flowchart TD
    classDef foundation fill:#b3e5fc,stroke:#0288d1,stroke-width:2px,color:#0d1b2a;
    classDef strategy fill:#c8e6c9,stroke:#388e3c,stroke-width:2px,color:#0f5132;
    classDef reasoning fill:#ffe0b2,stroke:#f57c00,stroke-width:2px,color:#663c00;
    classDef governance fill:#f8bbd0,stroke:#c2185b,stroke-width:2px,color:#842029;
    classDef execution fill:#cfd8dc,stroke:#455a64,stroke-width:2px,color:#212529;
    classDef safety fill:#e1bee7,stroke:#7b1fa2,stroke-width:2px,color:#4a148c;

    A["1. Research Foundation<br><b>quantitative-trading-lab</b>"] -->|Mathematical Theory| B["2. Strategy Parameters<br><b>maxdama-trading</b>"]
    B -->|Backtest Parameters| C["3. Institutional Analysis<br><b>institutional-finance-skills</b>"]
    C -->|Regime Identification| D["4. Decision Intelligence<br><b>hyperbot-ai-trading-claude-skill</b>"]
    D -->|Signal Rationale| E["5. Central AI Governance<br><b>finstack-skills</b>"]
    E -->|Approved PR-Score >= 80| F["6. Execution Governance<br><b>institutional-trade-harness</b>"]
    F -->|Telemetry Logs| G["7. Behavioral Safety Layer<br><b>ai-risk-copilot</b>"]
